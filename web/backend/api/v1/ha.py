...
def _get_monitor_components():
    ...
    if (_monitor_cache["last_update"] == 0 or
        _monitor_cache["cpu_monitor"] is None):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if isinstance(state, (float, int)):
                    ...
                    if unit_of_measurement == "W" and isinstance(attributes.get("state"), (float, int)):
    ...
    try:
        ...
        if external_power is not None:
            ...
            return jsonify(ok({
                ...
                "last_updated": importlib.import_module("datetime").datetime.now().isoformat()
            }))
